...
#define NUM_I2C_SLAVE_DEVICES 2
...
typedef struct
{
    void (*i2c_process_received_data)(I2C_Settings *, I2C_Storage *, I2C_FSM *);
    void (*i2c_process_address)(I2C_Settings *, I2C_Storage *, I2C_FSM *, I2C_Callback_Info *);
} I2C_Callbacks;
