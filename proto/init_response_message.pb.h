...
#ifndef PB_PROTO_INIT_RESPONSE_MESSAGE_PB_H_INCLUDED
#define PB_PROTO_INIT_RESPONSE_MESSAGE_PB_H_INCLUDED
#include <pb.h>
...
#define PROTO_INIT_RESPONSE_MESSAGE_PB_H_MAX_SIZE InitializeBoard_size
